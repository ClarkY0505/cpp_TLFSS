...
void Logger::initConsole(const std::string& name, spdlog::level::level_enum level,
...
void Logger::initFile(const std::string& name, const std::string& filepath,
...
void Logger::initRotating(const std::string& name, const std::string& filepath, size_t maxFileSize,
...
void Logger::initBoth(const std::string& name, const std::string& filepath,
                      spdlog::level::level_enum level, const std::string& pattern) {
